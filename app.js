...
function mostrarVideos(lista) {
  ...
  const castReady = window.cast && window.cast.framework &&
    cast.framework.CastContext.getInstance().getCastState() !== "NO_DEVICES_AVAILABLE";
...
window['__onGCastApiAvailable'] = function(isAvailable) {
  if (isAvailable) {
    ...
    // Volver a renderizar los videos para habilitar los botones
    mostrarVideos(todosLosVideos);
  }
};
}
